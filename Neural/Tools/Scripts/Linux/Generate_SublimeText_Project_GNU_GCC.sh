...
## Rebuild Project
cmake -G "Sublime Text 2 - Unix Makefiles" -DNEURAL_USE_CONFIG:BOOL=ON -DCMAKE_BUILD_TYPE=Release -DNEURAL_EXPLICIT_COMPILER_ID:STRING="GCC" -DNEURAL_EXPLICIT_HOST_ID:STRING="GNU" ../../Source
...
## Rebuild Project
cmake -G "Sublime Text 2 - Unix Makefiles" -DNEURAL_USE_CONFIG:BOOL=ON -DCMAKE_BUILD_TYPE=Debug -DNEURAL_EXPLICIT_COMPILER_ID:STRING="GCC" -DNEURAL_EXPLICIT_HOST_ID:STRING="GNU" ../../Source